...
const perguntas = [
    {
        ...
        respostas: [
            { opcao: "René Descartes", correto: true },
            { opcao: "Platão", correto: false },
    ...
    },
    {
        ...
        respostas: [
            { opcao: "1943", correto: false },
            { opcao: "1945", correto: true },
            { opcao: "1950", correto: false },
            { opcao: "1939", correto: false }
        ]
    },
];

// PARTE 2: Pegando os elementos do HTML
const perguntaElemento = document.querySelector(".perguntas");
